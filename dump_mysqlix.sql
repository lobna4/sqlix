...
--
-- Host: localhost    Database: mysqlix
-- ------------------------------------------------------
...
--
-- Current Database: `mysqlix`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `mysqlix` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
CREATE TABLE `fabriquer` (
  ...
  CONSTRAINT `fabriquer_ibfk_2` FOREIGN KEY (`NumPotion`) REFERENCES `habitant` (`NumHab`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `trophee` (
  ...
  CONSTRAINT `trophee_ibfk_1` FOREIGN KEY (`CodeCat`) REFERENCES `categorie` (`CodeCat`),
  CONSTRAINT `trophee_ibfk_2` FOREIGN KEY (`NumPreneur`) REFERENCES `habitant` (`NumHab`),
...
-- Dump completed on 2021-02-23 10:11:02
